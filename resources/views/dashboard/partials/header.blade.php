        ...
        <nav class="navbar navbar-expand-lg  p-0">
            <div class="navbar-header  h-100 h4 mb-0 d-flex align-items-center logo-bar text-left">  
                <a href="{{ route('home') }}" class="horizontal-logo text-left">
                    ...
                    @else
                        <span class="h4 font-weight-bold align-self-center mb-0 ml-auto">{{ $settings->title }}</span>
                    @endif
                ...
                <ul class="ml-auto p-0 m-0 list-unstyled d-flex top-icon h-100">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right border  py-0">
                            <li>
                                <a class="dropdown-item px-2 py-2 border border-top-0 border-left-0 border-right-0" href="#">
                                    <div class="media">
                                        <img src="{{ asset('assets/images/author.jpg') }}" alt="" class="d-flex mr-3 img-fluid rounded-circle">
                            ...
                            <li>
                                <a class="dropdown-item px-2 py-2 border border-top-0 border-left-0 border-right-0" href="#">
                                    <div class="media">
                                        <img src="{{ asset('assets/images/author2.jpg') }}" alt="" class="d-flex mr-3 img-fluid rounded-circle">
                                        <div class="media-body">
                            ...
                            <li>
                                <a class="dropdown-item px-2 py-2 border border-top-0 border-left-0 border-right-0" href="#">
                                    <div class="media">
                                        <img src="{{ asset('assets/images/author3.jpg') }}" alt="" class="d-flex mr-3 img-fluid rounded-circle">
                                        <div class="media-body">
                                            <p class="mb-0">Bill</p>
                    ...
                    <li class="dropdown align-self-center d-inline-block">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right border   py-0">
                            <li>
                                <a class="dropdown-item px-2 py-2 border border-top-0 border-left-0 border-right-0" href="#">
                                    <div class="media">
                                        <img src="{{ asset('assets/images/author.jpg') }}" alt="" class="d-flex mr-3 img-fluid rounded-circle w-50">
                                        <div class="media-body">
                    ...
                    <li class="dropdown user-profile align-self-center d-inline-block">
                        <a href="#" class="nav-link py-0" data-toggle="dropdown" aria-expanded="false"> 
                            <div class="media">                                   
                                <img src="{{ Auth::user()->avatar ? asset('avatars/'.Auth::user()->avatar) : asset('default-avatar.webp') }}" alt="" class="d-flex img-fluid rounded-circle" width="29">
                            </div>
                        </a>
                        ...
                        <div class="dropdown-menu border dropdown-menu-right p-0">
                            ...
                            <form action="{{ route('logout') }}" method="post">
                                @csrf
                                <button type="submit" class="dropdown-item px-2 text-danger align-self-center d-flex">
                                    <span class="icon-logout mr-2 h6  mb-0"></span> Sign Out</button>
                            </form>
                        </div>
                    </li>
                </ul>
